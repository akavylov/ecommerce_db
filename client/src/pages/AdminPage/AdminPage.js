                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label htmlFor="description"
                                       className="block mb-2 text-lg font-serif">Описание:</label>
                                <textarea {...register('description')} id="description" cols="30" rows="5" placeholder="whrite here.."
                            ...
                            <div>
                                <label htmlFor="image" className="inline-block mr-3 font-serif">Изображение:</label>
